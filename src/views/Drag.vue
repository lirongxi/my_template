<!-- <template>
    <div>
        <draggable class="components-draggable">
            <h1>666</h1>
            <h1>111</h1>
            <h1 @click="draggableCliak">6622226</h1>
        </draggable>
    </div>
</template>
<script>
                  ...
                  <el-checkbox-group v-model="form.type">
                    ...
                    <el-checkbox label="单纯" name="type"></el-checkbox>
                                ...
                                <el-form-item label="日期时间">
                                    <el-date-picker v-model="datetimevalue" type="datetime" placeholder="选择日期时间" align="right" :picker-options="pickerOptions1">
                                    </el-date-picker>
                                </el-form-item>
                            </div>
                ...
                <div class="grid-content">
                    ...
                    <el-tabs v-model="editableTabsValue" type="card" editable @edit="handleTabsEdit">
                        <el-tab-pane :key="item.name" v-for="(item, index) in editableTabs" :label="item.title" :name="item.name">
                            <!--视图区-->
                            <div class="tab-content" id="box" v-model="htmlcode" @dragstart='removedrop($event)' @drop='copydrap($event)' @dragover='allowDrop($event)'>
                                {{item.content}}
                            </div>
                        </el-tab-pane>
                    </el-tabs>
